...
function MypageNavbar() {
    return(
        <div className="flex text-emerald-800 flex-col justify-start items-center w-fit h-screen bg-amber-50 text-5xl py-8 px-16 font-amatic">
            <button className=" my-20">Mindful Trackers</button>
            <div>
